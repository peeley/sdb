...
func ParseJoinClause(input, leftTableName string) (*statements.JoinClause, error) {
	...
	var joinType statements.JoinType
	if strings.HasPrefix(trimmed, ",") {
		joinType = statements.InnerJoin
	...
	if joinType == statements.InnerJoin {
